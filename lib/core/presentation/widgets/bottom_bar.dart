...
import 'package:rinavent/core/common/animations/slide_transition_page.dart';
import 'package:rinavent/core/l10n/app_localizations.dart';
import 'package:rinavent/core/presentation/widgets/custom_bottom_bar.dart';
  ...
  Widget _buildBottomNavigationBar() {
    ...
    List<BottomMenuModel> bottomMenuList = [
      BottomMenuModel(
        ...
        title: appLocalization!.lbl_home,
        ...
        title: appLocalization.lbl_deposits,
        type: BottomBarEnum.Deposits,
      ),
      BottomMenuModel(
        icon: ImageConstant.imgTwoArrows1,
        activeIcon: ImageConstant.imgTwoArrows1,
        title: appLocalization.lbl_transfers,
        type: BottomBarEnum.Transfers,
      ),

        BottomMenuModel(
        icon: ImageConstant.loanUnSelected,
        activeIcon: ImageConstant.loanSelected,
        title: appLocalization.lbl_withdraw,
      ...
      BottomMenuModel(
        ...
        title: appLocalization.lbl_profile,
