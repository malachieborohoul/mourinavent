...
import 'package:rinavent/core/presentation/widgets/bottom_bar.dart';
import 'package:rinavent/core/presentation/widgets/custom_error404.dart';
    ...
    return Scaffold(
        ...
        BlocConsumer<AuthBloc, AuthState>(
          listener: (context, state) {
            ...
            //  Navigator.pushReplacement(context, LoadingCurrencyScreen.route());
            }
            else if (
