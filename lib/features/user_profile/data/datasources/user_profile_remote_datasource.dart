...
abstract interface class UserProfileRemoteDatasource {
  Future<UserModel> completeUserProfile(UserModel user, List<Category> selectedCategories);
...
class UserProfileRemoteDatasourceImpl implements UserProfileRemoteDatasource {
  ...
  @override
  Future<UserModel> completeUserProfile(UserModel user, List<Category> selectedCategories) async {
    try {
      final userData =
          await supabaseClient.from('profiles').update(user.toMap());
